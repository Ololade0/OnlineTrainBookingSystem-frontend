...
// //         });
// //         setErrors({});
// //         if (onSuccess) onSuccess(); // ✅ notify parent (StaffList)
// //       } else {
// //         // ✅ Only backend error message shown
// //         toast.error(data.message || "Failed to create staff");
// //       }
// //     } catch (err) {
// //       console.error(err);
...
// //         <h2 className="form-title">Create Staff</h2>
// //         <form onSubmit={handleSubmit} className="form" noValidate>
// //           {/* ... keep your same input fields here ... */}
// //           <button type="submit" className="submit-btn" disabled={isSubmitting}>
// //             {isSubmitting ? "Creating..." : "Create Staff"}
// //           </button>
// //         </form>
...
import { useAuth } from "../context/AuthContext";
import { toast } from "react-toastify";
import "../styles/StaffForm.module.css";
...
const StaffForm = ({ onSuccess }) => {
  ...
  const [form, setForm] = useState({
    ...
    identificationType: "", idNumber: "", roleType: "",
  });
  const [errors, setErrors] = useState({});
  const [isSubmitting, setIsSubmitting] = useState(false);
